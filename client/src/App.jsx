            ...
            <Route path="/admin" element={<SharedLayout title="Admin Dashboard" description="Manage every piece of content shown on Suggula's Kitchen." />}>
              <Route element={<AdminRoute />}>
                <Route element={<AdminDashboard />}>
                  ...
                  <Route path="customers" element={<AdminDatabaseTable table="customers" />} />
                  <Route path="orders" element={<AdminDatabaseTable table="orders" />} />
                  <Route path="shipping" element={<AdminDatabaseTable table="shipping" />} />
                </Route>
              </Route>
            </Route>
