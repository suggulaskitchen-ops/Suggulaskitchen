...
function AdminDashboard() {
  return (
    <div className="grid gap-5 lg:grid-cols-[205px_minmax(0,1fr)] lg:items-start">
      <nav className="sticky top-3 z-30 flex gap-1 overflow-x-auto rounded-2xl border border-white/10 bg-[#2b3325]/95 p-2 shadow-xl shadow-black/15 backdrop-blur-md lg:flex-col">
        {navItems.map((item) => (
          <NavLink
            key={item.path}
            to={item.path}
