...
function AdminLogin() {
  ...
  return (
    <div className="mx-auto flex min-h-[75vh] w-full max-w-md items-center justify-center">
      <div className="w-full rounded-[2rem] border border-slate-200 bg-white p-8 shadow-2xl sm:p-10">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">Sign in with the admin credentials to manage the website.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button type="submit" className="mt-2 w-full rounded-2xl bg-emerald-600 px-5 py-3 text-sm font-semibold text-white transition hover:bg-emerald-500">
            Sign in
          </button>
        </form>
      </div>
