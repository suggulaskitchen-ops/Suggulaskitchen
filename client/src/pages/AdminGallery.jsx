    ...
    <div className="space-y-8 rounded-[2rem] bg-slate-900/90 p-8 text-slate-100 shadow-2xl shadow-black/20">
      ...
      <form onSubmit={handleSubmit} className="grid gap-6 lg:grid-cols-2">
        ...
        <label className="space-y-2">
          ...
          <select name="mediaType" value={form.mediaType} onChange={handleChange} className="w-full rounded-3xl border border-slate-700 bg-slate-950 px-4 py-3 text-slate-100 outline-none transition focus:border-emerald-500">
        ...
        <label className="space-y-2">
          <span className="text-sm font-medium text-slate-200">Social media URL</span>
          <input name="mediaUrl" type="url" value={form.mediaUrl} onChange={handleChange} placeholder="https://..." className="w-full rounded-3xl border border-slate-700 bg-slate-950 px-4 py-3 text-slate-100 outline-none transition focus:border-emerald-500" />
        </label>
